...
import com.vizy.ignitar.app.TextRecognition.TextRecoRenderer;
...
import com.vizy.ignitar.app.TextRecognition.TextRecoRenderer.WordDesc;
...
public class TextReco extends Activity implements SampleApplicationControl {
    ...
    public void updateWordListUI(final List<WordDesc> words) {
    ...
    private void showLoupe(boolean isActive) {
        ...
        wordListLayout.setBackgroundColor(getResources().getColor(R.color.transparent));
