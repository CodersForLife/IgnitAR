...
package com.vizy.ignitar.app.TextRecognition;
...
import com.vizy.ignitar.activities.TextReco;
import com.vizy.ignitar.utils.LineShaders;
...
public class TextRecoRenderer implements GLSurfaceView.Renderer
{
    ...
    public List<WordDesc> mWords = new ArrayList<WordDesc>();
