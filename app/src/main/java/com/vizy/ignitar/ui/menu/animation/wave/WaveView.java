...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#28f16d7a");
...
//                    canvas.drawLine(15f,15f,150f,700f,mBorderPaint);
//                    canvas.drawLine(100f,100f,00f,700f,mBorderPaint);
//                    canvas.drawLine(40f,40f,50f,70f,mViewPaint);
//                    Drawable drawable=getResources().getDrawable(R.mipmap.ic_chai);
//                    drawable.setBounds(0,0,(int)(getWidth()/1.5f),(int)(getHeight()/1.5f));
//                    drawable.setColorFilter(getResources().getColor(R.color.green), PorterDuff.Mode.ADD);
